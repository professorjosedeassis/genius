/**
   Jogo de memória GENIUS (Simon)
   @author Professor José de Assis
   @version 3.0
   @link https://roboticapratica.com.br/arduino.html

/*
  Vetor usado para armazenar a sequência da rodada.
  "12" é o número máximo de rodadas (0 a 11).
  Você pode aumentar este valor para deixar o jogo
  mais difícil, neste caso alterar também a linha 81.
*/
int sequencia[12] = {};

/*
  Vetores usados para associar o botão com a cor do LED
